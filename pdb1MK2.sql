CREATE OR REPLACE PACKAGE RENTAL AS
    ...
    TYPE BOOK_RECORD IS RECORD (TITLE_ID NUMBER, LOCATION_ID NUMBER, BOOK_VALUE NUMBER, CONDITION NUMBER, 
        BUY_DATE DATE, DELIVERY_ID NUMBER);
    
    TYPE BORROWS_RECORD IS RECORD (BOOK_ID NUMBER, READER_ID NUMBER, START_DATE DATE);
    
    TYPE H_BORROWS_RECORD IS RECORD (BOOK_ID NUMBER, READER_ID NUMBER,
        START_DATE DATE, END_DATE DATE, BORROW_RESULT VARCHAR2(70), CONDITION_CHANGE NUMBER);
    
    TYPE ADDRESS_RECORD IS RECORD (POSTAL_CODE VARCHAR2(10), POSTAL_CITY VARCHAR2(70), 
    ...
    TYPE READER_RECORD IS RECORD (FIRST_NAMES VARCHAR2(100), LAST_NAMES VARCHAR2(100),
    ...
    FUNCTION ADD_BOOKS (TITLE_ID NUMBER, ADDED_BOOKS_LOCATIONS LOCATIONS_DICTIONARY, HOW_MANY_BOOKS NUMBER,
        ADDED_BOOKS_VALUE NUMBER, ADDED_BOOKS_CONDITION NUMBER, ADDED_BOOKS_BUY_DATE DATE, DELIVERY_ID NUMBER) 
        RETURN ID_ARRAY;
