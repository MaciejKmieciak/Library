CREATE OR REPLACE PACKAGE RENTAL AS
    ...
    LOCATION_LOCKNAME VARCHAR2(128) := 'LOCATION_LOCK';
    LOCATION_LOCKHANDLE VARCHAR2(128);
    ...
    FUNCTION LOCK_LOCATION (T_LOCATION_ID NUMBER, T_TIMEOUT INTEGER := 0) 
        RETURN INTEGER;
    
    --FUNCTION GET_LOCATION_LOCKHANDLE RETURN VARCHAR2;
    --FUNCTION RELEASE_LOCATION RETURN INTEGER;
