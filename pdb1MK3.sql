CREATE OR REPLACE PACKAGE BODY RENTAL AS
    ...
    /*
    ERR_20000_INFO VARCHAR2(4000) := 'AUTHOR''S LAST NAME CANNOT BE NULL';
    ERR_20001_INFO VARCHAR2(4000) := 'AUTHOR''S BIRTH DATE CANNOT BE LATER THAN THEIR DEATH DATE';
    ERR_20002_INFO VARCHAR2(4000) := 'AUTHOR''S BIRTH AND DEATH DATES CANNOT BE LATER THAN SYSDATE';
    ERR_20003_INFO VARCHAR2(4000) := 'TITLE CANNOT BE NULL';
    ERR_20004_INFO VARCHAR2(4000) := 'TITLE''S AGE LIMIT MUST BE BETWEEN 7 AND 18';
    ERR_20005_INFO VARCHAR2(4000) := 'NUMBER OF ADDED BOOKS CANNOT BE ZERO';
    ERR_20006_INFO VARCHAR2(4000) := 'NOT ENOUGH FREE LOCATIONS FOR THIS DELIVERY';
    ERR_20007_INFO VARCHAR2(4000) := 'BOOK''S VALUE MUST BE POSITIVE';
    ERR_20008_INFO VARCHAR2(4000) := 'BOOK''S CONDITION MUST BE BETWEEN 1 AND 5';
    ERR_20009_INFO VARCHAR2(4000) := 'BUY DATE MUST BE LATER OR EQUAL TO 01.09.2022';
    ERR_20010_INFO VARCHAR2(4000) := 'PARAMETER ERROR TRYING TO REQUEST LOCK ON LOCATION';
    ERR_20011_INFO VARCHAR2(4000) := 'LOCK ALREADY RELESED WHILE TRYING TO RELEASE LOCK ON LOCATION';
    ERR_20012_INFO VARCHAR2(4000) := 'ILLEGAL LOCKHANDLE TRYING TO REQUEST LOCK ON LOCATION';
    ERR_20013_INFO VARCHAR2(4000) := 'TITLE ERROR TRYING TO CREATE AUTHORS-TITLE RELATION';
    ERR_20014_INFO VARCHAR2(4000) := 'AUTHOR ERROR TRYING TO CREATE AUTHORS-TITLE RELATION';
    ERR_20015_INFO VARCHAR2(4000) := 'DEADLOCK TRYING TO REQUEST LOCK ON LOCATION';
    ERR_20016_INFO VARCHAR2(4000) := 'PARAMETER ERROR TRYING TO RELEASE LOCK ON LOCATION';
    ERR_20017_INFO VARCHAR2(4000) := 'ILLEGAL LOCKHANDLE TRYING TO RELEASE LOCK ON LOCATION';
    ERR_20018_INFO VARCHAR2(4000) := 'GIVEN LOCATION DOES NOT EXIST';
    ERR_20019_INFO VARCHAR2(4000) := 'NON-EXISTENT LOCATION_ID TRYING TO REQUEST LOCK ON LOCATION';
    ERR_20020_INFO VARCHAR2(4000) := 'NON-EXISTENT LOCATION_ID TRYING TO RELEASE LOCK ON LOCATION';
    */
    ...
    BEGIN
        T_ADDRESS_RECORD := ADDRESS_RECORD(ADDRESS_ID, POSTAL_CODE, POSTAL_CITY, CITY, 
            STREET, HOUSE_NO, FLAT_NO, NOTES);
    ...
    IS
    BEGIN
        IF T_ADDRESS_RECORD.ADDRESS_ID IS NULL THEN
            RETURN ADD_ADDRESS(T_ADDRESS_RECORD);
        END IF;
        RETURN T_ADDRESS_RECORD.ADDRESS_ID;
    END PICK_ADDRESS;
    ...
    BEGIN
        ...
        RETURN PICK_ADDRESS (T_ADDRESS_RECORD);
    END PICK_ADDRESS;
    ...
    BEGIN
        ...
        AND BIRTH_DATE = T_READER_RECORD.JOIN_DATE
    ...
    BEGIN
        T_READER_RECORD := READER_RECORD(READER_ID, FIRST_NAMES, LAST_NAMES, JOIN_DATE,
